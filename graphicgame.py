...
class GUI:
    def __init__(self, w, h, size):
        ...
        self.surfacew = w
        self.surfaceh = h
        self.grid_surface = pygame.Surface([self.surfacew, self.surfaceh])
        self.camerax = 0
        self.cameray = 0
        self.zoomfactor = 1
    ...
    def createMaze(self):
        ...
        self.surfacew = self.cellWidth*self.size + 20
        self.surfaceh = self.cellHeight*self.size + 20
        self.grid_surface = pygame.Surface([self.surfacew, self.surfaceh])
    ...
    def draw(self):
        ...
        self.grid_surface.fill(pygame.Color(255,255,255))
        ...
        for r in range(self.size):
            for c in range(self.size):
                if self.grid[r][c].top == 1:
                    pygame.draw.line(self.grid_surface, (0,0,0), [10+self.cellWidth*c, 10+self.cellHeight*r], [10+self.cellWidth*(c+1), 10+self.cellHeight*r], 1)
                ...
                if self.grid[r][c].right == 1:
                    pygame.draw.line(self.grid_surface, (0,0,0), [10+self.cellWidth*(c+1), 10+self.cellHeight*r], [10+self.cellWidth*(c+1), 10+self.cellHeight*(r+1)], 1)
                ...
                if self.grid[r][c].bottom == 1:
                    pygame.draw.line(self.grid_surface, (0,0,0), [10+self.cellWidth*c, 10+self.cellHeight*(r+1)], [10+self.cellWidth*(c+1), 10+self.cellHeight*(r+1)], 1)
                ...
                if self.grid[r][c].left == 1:
                    pygame.draw.line(self.grid_surface, (0,0,0), [10+self.cellWidth*c, 10+self.cellHeight*r], [10+self.cellWidth*c, 10+self.cellHeight*(r+1)], 1)
                    #self.canvas.create_line(10+self.cellWidth*c, 10+self.cellHeight*r, 10+self.cellWidth*c, 10+self.cellHeight*(r+1))
        self.screen.blit(self.grid_surface, (self.camerax, self.cameray))
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if event.button == 4:
                        self.zoomfactor += 0.1
                        self.grid_surface = pygame.transform.smoothscale(self.grid_surface, (int(self.surfacew*self.zoomfactor), int(self.surfaceh*self.zoomfactor)))
                        self.screen.fill(pygame.Color(255,255,255))
                        self.screen.blit(self.grid_surface, (self.camerax, self.cameray))
                    if event.button == 5 and self.zoomfactor>0.1:
                        self.zoomfactor -= 0.1
                        self.grid_surface = pygame.transform.smoothscale(self.grid_surface, (int(self.surfacew*self.zoomfactor), int(self.surfaceh*self.zoomfactor)))
                        self.screen.fill(pygame.Color(255,255,255))
                        self.screen.blit(self.grid_surface, (self.camerax, self.cameray))
            pygame.display.flip()
            self.clock.tick(30) #30 frame per second
